...
func (svc *RevenueSvc) _generatePay(payDao *dao.PayDao, cDate time.Time) (data *dao.Pay, err error) {
	...
	return &dao.Pay{
		...
		RechargeAmountHuiFu:        payGroup.Recharge.RechargeAmountHuiFu,
		...
		RechargeRefundAmountHuiFu:  payGroup.RechargeRefund.RechargeRefundAmountHuiFu,
		...
		DiscountAmountHuiFu:        payGroup.Recharge.DiscountAmountHuiFu,
		...
		SavingAmountHuiFu:          payGroup.Saving.SavingAmountHuiFu,
