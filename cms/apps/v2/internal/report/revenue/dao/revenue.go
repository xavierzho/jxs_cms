...
func (d *RevenueDao) All(dateRange [2]time.Time) (data []map[string]interface{}, err error) {
	...
	select
		...
		bal.jidou as jidou_balance,
		bal.point as point_balance,
		bal.loyalty as loyalty_balance,
		pay.amount as pay_amount,
		pay.amount_balance as pay_amount_balance,
		pay.amount_jidou as pay_amount_jidou,
		pay.amount_points as pay_amount_points,
		pay.amount_loyalty as pay_amount_loyalty,
