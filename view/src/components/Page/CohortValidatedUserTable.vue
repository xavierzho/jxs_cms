<template>
  ...
  >
    <template v-slot:table-column>
      ...
      <el-table-column prop="total" :label="$t('report.cohort.new_user_validated.total')" min-width="90px" align="center">
        <template v-slot="scope">
          {{ scope.row.total | localeNum }}
        </template>
      </el-table-column>
      <el-table-column prop="first_day" :label="$t('report.cohort.new_user_validated.first_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="second_day" :label="$t('report.cohort.new_user_validated.second_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="third_day" :label="$t('report.cohort.new_user_validated.third_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="fourth_day" :label="$t('report.cohort.new_user_validated.fourth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="fifth_day" :label="$t('report.cohort.new_user_validated.fifth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="sixth_day" :label="$t('report.cohort.new_user_validated.sixth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="seventh_day" :label="$t('report.cohort.new_user_validated.seventh_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="fourteenth_day" :label="$t('report.cohort.new_user_validated.fourteenth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="thirtieth_day" :label="$t('report.cohort.new_user_validated.thirtieth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="sixtieth_day" :label="$t('report.cohort.new_user_validated.sixtieth_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="ninety_day" :label="$t('report.cohort.new_user_validated.ninety_day')" min-width="90px" align="center">
        <template v-slot="scope">
      ...
      <el-table-column prop="no_180_day" :label="$t('report.cohort.new_user_validated.no_180_day')" min-width="100px" align="center">
        <template v-slot="scope">
